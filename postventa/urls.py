...
urlpatterns = [
    ...
    path('perfil/editar/', UserSelfProfileUpdateView.as_view(), name='profile_edit'),
    path('postventas/export/', export_postventas, name='postventa_export'),
